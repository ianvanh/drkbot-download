...
*Por favor seleccione MP3/MP4*`
                        ...
                        sendFileUrl(id,i.url,video,'DrkBot','',m)
                        } else {
                        sendFileUrl(id,i.url,image,'DrkBot','',m)     
                        }
                }
...
*Upload* : ${buffer.upload}`
        ...
        switch(chats) {
                ...
                case 'WM':
                        ...
                        sendFileUrl(id,buffer_.wm,video,'DrkBot','',m)
                break
                case 'NO WM':
                        balas(id,Wait,m)
                        ...
                        sendFileUrl(id,buffer__.nowm,video,'DrkBot','',m)
                break
                case 'OWNER':
